...
describe('CategoryToMatchTransformer', () => {
    ...
    describe('Constructor', () => {
        ...
        it.each([
          ...
          'throws an error on a %s concurrency limit',
          (name, concurrencyLimit) => {
            ...
            }).toThrow('concurrencyLimit must be an integer greater than zero.');
          }
        );
    ...
    describe('tokenizeName', () => {
        ...
        it.each([
            ...
            ['numeric', 'Numeric', 1],
            ['non-alphanumeric token', 'Emoji', 2]
    ...
    describe('ValidateConfig', () => {
        ...
        it.each([
            ...
            [
                'has invalid socket limit',
                {
                    ...GOOD_STEP_CONFIG,
                    socketLimit: 'chicken'
                },
                [
                  new Error("socketLimit must be a number greater than 0")
                ]
            ],
            [
                'has non-positive socket limit',
                {
                    ...GOOD_STEP_CONFIG,
                    socketLimit: -5
                },
        ...
        async (name, concurrencyLimit) => {
          ...
          try {
            ...
            expect(error).toMatchObject({
              message: 'concurrencyLimit must be an integer greater than zero.'
            })
